...
const drinkChoice = "Long Island Iced Tea";
const foodChoice = "Chicken Fettichini with Vodka Sauce";

let name = "Kidron";
let friendName = "Joey";

//Question: Name a reason why you would use const instead of let.
//Answer: You would use const in an instance when there is a value that you would not want to be mutable. If it is a constant value.
...
console.log(`Hello, ${name} and my friend ${friendName}, are going to have ${drinkChoice} and ${foodChoice}.`);
...
//const drinkChoice = "Bloody Mary"
//console.log(drinkChoice);

//Question: Read the error message - in your own words - what does it mean?
//Answer: Since drinkChoice is a const value, it is a value that is immutible and can't be changed.
...
let lunchTime = (foodChoice,drinkChoice) => {
    return `Hello, ${name} and my friend ${friendName}, are going to have ${drinkChoice} and ${foodChoice}.`;
}
...
console.log(foodForTodayAndTomorrow(foodChoice, drinkChoice, lunchTime("Pizza", "Water")))
